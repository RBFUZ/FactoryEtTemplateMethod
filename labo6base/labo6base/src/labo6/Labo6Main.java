...
public class Labo6Main extends JFrame
{
    ...
    private static String sessionType = Session.getNormalSession();
     ...
     * l'utilisateur humain change de caract�ristiques, la session ne peut donc
     * plus continuer.
     */
    ...
    /*
     * Initialisation de la fen�tre. Long script d�sagr�able. Ne vous pr�ocuppez
     * pas de ce code.
     */
    private void initUI()
    {
